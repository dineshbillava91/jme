<script type="text/javascript">
	$(document).ready(function(){
		...
		$.ajax({
			...
			data: {'data[VideoRelate][related_video_ids]':relatedVideoIds, 'data[Video][id]':video_id},
...
<section class="mainContentBlock">
	...
	<section class="registrationContainer3">
		...
		<fieldset class="srchfldset" style="width:110px;">
			<?php echo $this->Html->link($this->Html->image("show_videos.png", array("alt"=>"Cancel")),'javascript:void(0);',array('id'=>'show_videos', 'escape'=>false)); ?>
		</fieldset>
		...
		<?php echo $this->Form->create('VideoRelate'); ?>
			...
			<fieldset class="videofldset">
				...
				<span class="regisrtSelectfld">
					<?php 
						echo $this->Form->select('VideoRelate.related_video', $related_videos, array('multiple'=>true)); 
			...
			<fieldset class="srchfldset" style="width:100%;">
				<?php
					echo $this->Html->link($this->Html->image('save_button.png', array('class'=>'submitBtnVideoRelate', 'alt'=>'Save')),'javascript:void(0);',array('id'=>'saveEditRelatedVideos', 'escape'=>false));
